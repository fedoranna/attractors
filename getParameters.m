...
if v == 0
    ...
    P.threshold = 5;                   % activation threshold for transferfn_step
    
    % Input    
    P.nbof_patterns = 100;               % number of patterns in the testing set
...
elseif v == 1 % as in Rolls, 2012; threshold set manually
...
elseif v == 2 % -1/+1 neurons and simple learning, no memory traces

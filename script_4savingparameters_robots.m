...
S.task = 'robots';                   % Name of the task
...
S.fitness_measure = 'fitness_robots'; % choose from the fields of T - see in calculate_performance fn
...
% Architecture
P.nbof_neurons = 800;               % number of neurons: 100 neurons/motor, 8 motors
...
% Input
P.sparseness_provoking = [0, 0, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]; % sparseness of first generation provoking patterns (one value / motor)
